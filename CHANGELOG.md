...
- Align npm, Release archive, and source installation instructions with `0.1.3`, restore npmjs lockfile URLs without changing package versions or integrity, and ignore local CodeGraph files.
